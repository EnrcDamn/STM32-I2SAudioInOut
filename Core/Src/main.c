...
/**
  ...
  ******************************************************************************
  ...
  I2S source: https://audiodsplab.wordpress.com/ping-pong-buffer-audio-stream/
  */
...
void HAL_I2SEx_TxRxHalfCpltCallback(I2S_HandleTypeDef *hi2s)
{
	...
	txBuf[1] = (lOut<<8) & 0xFFFF;
	txBuf[2] = (rOut>>8) & 0xFFFF;
	txBuf[3] = (rOut<<8) & 0xFFFF;
}
